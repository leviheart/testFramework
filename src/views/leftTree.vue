<template>
  <div class="leftTree">
    ...
    <div style="display: inline-block;">
      <el-dialog :visible.sync="dialog" :close-on-click-modal="false" :before-close="cancel" :title="title"
...
export default {
  ...
  data() {
    return {
      ...
      detail: [{ id: 1, it1: 'it1', it2: 'it2', it3: 'it3' }, { id: 2, it1: 'it11', it2: 'it22', it3: 'it33' }]
    }
  },
  mounted() {
